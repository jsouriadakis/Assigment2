...
class JointStatePublisher():
    ...
    def callback(self, data):
        jointRotation = data.data
        rotations = jointRotation.split()
        t1 = float(rotations[0])
        t2 = float(rotations[1])
        self.updateJoints(t1,t2)

    def updateJoints(self,t1,t2):
        i = 1
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            for i, name in enumerate(self.joint_list):
                ...
                #msg.position[i] = joint['position'] + 1.0
...
if __name__ == '__main__':
    try:
        rospy.init_node('example_joint_state_publisher')
